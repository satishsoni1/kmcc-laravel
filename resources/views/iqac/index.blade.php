    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <main class="lg:col-span-2 space-y-6">
            <div class="bg-white rounded-xl shadow-md p-8">
                ...
                <p class="text-gray-600 mb-4">The Internal Quality Assurance Cell (IQAC) at KMCC College was established in accordance with the guidelines of the National Assessment and Accreditation Council (NAAC). The IQAC serves as the nerve centre for planning, guiding, and monitoring the quality enhancement activities of the institution.</p>
            ...
            <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
                ...
                <p class="text-gray-700 text-sm italic leading-relaxed">"Quality is not an act, it is a habit. At KMCC College, the IQAC strives to make quality-consciousness a living culture — embedded in every classroom, every administrative process, and every student interaction. Our goal is continuous improvement, not just compliance."</p>
