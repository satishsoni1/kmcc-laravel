@extends('layouts.app')
@section('title', 'NAAC Criteria Committees')
@section('content')
@include('partials._page-header', ['title' => 'NAAC Criteria Committees', 'breadcrumbs' => ['Governance' => route('governance.index'), 'NAAC Criteria Committees' => null]])
<div class="max-w-7xl mx-auto px-4 py-12">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <aside>@include('governance._sidebar')</aside>
        <main class="lg:col-span-2 space-y-6">
            <div class="bg-white rounded-xl shadow-md p-8">
                <h2 class="text-2xl font-bold mb-2" style="color:var(--kmc-navy);">NAAC Criteria Committees</h2>
                <div class="w-12 h-1 mb-4 rounded" style="background-color:var(--kmc-gold);"></div>
                <p class="text-gray-600 mb-6">These committees are constituted for the academic year 2025-26 (Ref. 408/2025-26, Date: 18/08/2025) to oversee NAAC accreditation criteria. Each committee works in coordination with the IQAC Coordinator, Principal, and Heads of Departments.</p>
                        ...
                        <div class="p-1">
                            ...
                            <table class="w-full text-sm border-collapse">
                                ...
                                <tbody class="divide-y divide-gray-100">
                                    ...
                                    <tr class="{{ $m->role === 'Chairman' ? 'bg-yellow-50' : 'hover:bg-gray-50' }}">
