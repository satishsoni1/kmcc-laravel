@extends('layouts.app')
@section('title', 'Board of Studies')
@section('content')
@include('partials._page-header', ['title' => 'Board of Studies', 'breadcrumbs' => ['Governance' => route('governance.index'), 'Board of Studies' => null]])
<div class="max-w-7xl mx-auto px-4 py-12">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <aside>@include('governance._sidebar')</aside>
        <main class="lg:col-span-2">
            <div class="bg-white rounded-xl shadow-md p-8">
                <h2 class="text-2xl font-bold mb-2" style="color:var(--kmc-navy);">Board of Studies</h2>
                <div class="w-12 h-1 mb-5 rounded" style="background-color:var(--kmc-gold);"></div>
                <p class="text-gray-600 mb-5">Each department has a Board of Studies responsible for designing, reviewing, and updating the curriculum to align with industry requirements, UGC guidelines, and NEP 2020.</p>
                    ...
                    <table class="w-full text-sm border-collapse">
                        <thead>
                            <tr class="text-white" style="background-color:var(--kmc-navy);">
                                ...
                                <th class="px-4 py-2.5 text-left">Role / Board</th>
                            </tr>
                        </thead>
