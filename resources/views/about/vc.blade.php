@extends('layouts.app')
@section('title', "From Desk of Vice-president's Desk")
@section('content')
@include('partials._page-header', ['title' => "From Desk of Vice-president's Desk", 'breadcrumbs' => ['About Us' => route('about.index'), "From Desk of Vice-president's Desk" => null]])
