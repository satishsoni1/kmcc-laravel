        ...
        <main class="lg:col-span-2">
            <div class="bg-white rounded-xl shadow-md p-8">
                ...
                <div class="flex flex-col md:flex-row gap-8 items-start">
                    <img src="{{ asset('images/college-shield.png') }}" alt="KMCC College Emblem" class="w-48 h-48 object-contain mx-auto md:mx-0">
                    ...
                    <div>
                        <p class="text-gray-600 leading-relaxed mb-4">The emblem of KMCC College symbolizes the institution's core values of knowledge, wisdom, and service. Each element of the emblem carries deep meaning reflecting our educational philosophy and cultural heritage.</p>
                        <ul class="space-y-3">
                            @foreach([
