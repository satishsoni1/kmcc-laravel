@extends('layouts.app')
@section('title', "From President's Desk")
@section('content')
@include('partials._page-header', ['title' => "From President's Desk", 'breadcrumbs' => ['About Us' => route('about.index'), "From President's Desk" => null]])
