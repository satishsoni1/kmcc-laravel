            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6 p-8">
                    ...
                    <div class="text-center sm:text-left">
                        <h2 class="text-2xl font-bold mb-1" style="color: var(--kmc-navy);">Shri Kishor B. Patil</h2>
                        <p class="text-base font-semibold mb-1" style="color: var(--kmc-crimson);">Secretary</p>
...
उज्ज्वल भविष्य आहे. धन्यवाद !!
                ...
                <div class="mt-8 pt-6 border-t border-gray-100 flex items-center gap-4">
                    ...
                    <div>
                        <p class="font-bold text-gray-800">Shri Kishor B. Patil</p>
                        <p class="text-sm text-gray-500">Secretary – K.T.S.P. Mandal, Khopoli.</p>
                    </div>
                </div>
            </div>
