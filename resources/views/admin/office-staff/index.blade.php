...
<div class="flex items-center justify-between mb-5">
    ...
    <a href="{{ route('admin.office-staff.create') }}"
    ...
    <table class="w-full text-sm">
        <thead class="bg-gray-50 border-b border-gray-100">
            <tr>
                ...
                <th class="px-4 py-3 text-left font-semibold text-gray-600 hidden sm:table-cell">Department</th>
                <th class="px-4 py-3 text-left font-semibold text-gray-600 hidden md:table-cell">Contact</th>
        ...
        <tbody class="divide-y divide-gray-50">
            ...
            <tr class="hover:bg-gray-50 transition-colors">
                ...
                <td class="px-4 py-3 hidden sm:table-cell text-gray-600 text-xs">{{ $member->department ?? '—' }}</td>
                <td class="px-4 py-3 hidden md:table-cell text-gray-500 text-xs">
                    ...
                    @if(!$member->phone && !$member->email)—@endif
                </td>
                ...
                <td class="px-4 py-3 text-right">
                    <div class="flex items-center justify-end gap-2">
                        <a href="{{ route('admin.office-staff.edit', $member) }}"
                           class="text-xs px-3 py-1.5 rounded-lg text-white font-medium"
                           style="background-color: #2d4077;">Edit</a>
                        <form action="{{ route('admin.office-staff.destroy', $member) }}" method="POST"
            ...
            <tr>
                <td colspan="5" class="px-4 py-12 text-center text-gray-400">
                    No office staff members found.
                    <a href="{{ route('admin.office-staff.create') }}" class="font-semibold" style="color: #2d4077;">Add the first one.</a>
                </td>
            </tr>
            @endforelse
        </tbody>
