...
class CollegeDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('exam_documents')->insert([
            ...
            // Results
            ['type'=>'result','title'=>'Result — T.Y.B.Sc. Semester V 2024-25','academic_year'=>'2024-25','semester'=>'Semester V','programme'=>'T.Y.B.Sc.','description'=>'Results declared on 20 January 2025. Revaluation window: 25 Jan – 05 Feb 2025.','file_path'=>null,'external_link'=>'https://university.example.com/results','is_active'=>1,'order'=>1,'created_at'=>$now,'updated_at'=>$now],
            ['type'=>'result','title'=>'Result — T.Y.B.Com. Semester V 2024-25','academic_year'=>'2024-25','semester'=>'Semester V','programme'=>'T.Y.B.Com.','description'=>'Results declared on 20 January 2025.','file_path'=>null,'external_link'=>'https://university.example.com/results','is_active'=>1,'order'=>2,'created_at'=>$now,'updated_at'=>$now],
            ['type'=>'result','title'=>'Result — T.Y.B.A. Semester V 2024-25','academic_year'=>'2024-25','semester'=>'Semester V','programme'=>'T.Y.B.A.','description'=>'Results declared on 22 January 2025.','file_path'=>null,'external_link'=>'https://university.example.com/results','is_active'=>1,'order'=>3,'created_at'=>$now,'updated_at'=>$now],
